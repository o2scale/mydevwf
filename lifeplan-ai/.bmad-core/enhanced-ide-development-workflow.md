...
| **After Development**    | `*review`   | Comprehensive assessment                | QA Results in story + `docs/qa/gates/sprint-{sprint}/epics/epic-{epic}/{epic}.{story}-{slug}.yml` | **Required**                |
| **Post-Review**          | `*gate`     | Update quality decision                 | Updated `docs/qa/gates/sprint-{sprint}/epics/epic-{epic}/{epic}.{story}-{slug}.yml`               | As needed                   |
...
4. **Gate Decision**
   - Creates: `docs/qa/gates/sprint-{sprint}/epics/epic-{epic}/{epic}.{story}-{slug}.yml`
